    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold text-slate-900 mb-6 tracking-tight text-balance leading-[1.1]">
            {BRAND.tagline}
          </h1>
        </div>

        <div className="animate-fade-in-delay">
          <p className="text-lg md:text-xl text-slate-500 mb-10 max-w-2xl mx-auto text-balance">
        ...
        <div className="animate-fade-in-delay-2 mt-16 flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-slate-400">
