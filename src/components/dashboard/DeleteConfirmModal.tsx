      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="glass-solid max-w-sm w-full shadow-xl">
          <div className="px-6 py-5 border-b border-slate-100">
            <h2 className="text-lg font-bold text-slate-900">Delete &ldquo;{patternName}&rdquo;?</h2>
          </div>
          <div className="px-6 py-6">
            <p className="text-slate-500 text-center text-sm">This action cannot be undone. Your pattern and all associated data will be permanently deleted.</p>
          </div>
